...
export default function About() {
    return (
        <div id="about">   
          ...
          <p>I'm a self-taught developer. This portfolio was originally created in 2021 and 2022 while I was landing my first coding job. Though it has lain dormant for a while, I am resurrecting it to serve as a visual focus for my job-search efforts. I won't be putting all projects back online, as they need to be transferred from create-react-app to vite, moved from Heroku to Render.io (RIP Heroku free tier) and have their outdated dependecies update. Needless to say, after several years working professionally, I would approach some of these projects differently that I did before, but I'm still proud of my work back then!</p>
