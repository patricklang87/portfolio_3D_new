...
export default function ProjectInfo({
  ...
  return (
    <div
      id={project.title}
      key={project.title}
      style={infoAppeared ? visibleStyle : invisibleStyle}
      className="ProjectCard"
    >
      <CgCloseO size="2em" className="closeButton" onClick={handleCloseInfo} />
      <h3>{project.title}</h3>
      ...
      <div className="linkButtons">
        ...
        {project.deployment_url && (
          <a href={project.deployment_url} target="_blank" rel="noreferrer">
            <button disabled={project.deploymentLinkDisabled}>
              Deployed Site
            </button>
          </a>
        )}
